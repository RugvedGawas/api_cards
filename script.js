...
// var serviceKey = "clicktocall_457_23122019105710";
// var datarequest = {};
// datarequest.flag = "2";
...
// var date = new Date();
// var requestdate = date.getFullYear() + "-" + (date.getMonth() + 1) + "-" + date.getDate() + " " + date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds();
// datarequest.reqdatetime = requestdate;

// // Convert datarequest to JSON
// var requestData = JSON.stringify(datarequest);
